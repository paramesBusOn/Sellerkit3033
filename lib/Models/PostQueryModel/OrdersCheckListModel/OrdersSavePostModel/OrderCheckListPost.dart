...
class OrdercheckListPostModal {
 ...
 OrdercheckListPostModal({
  ...
  factory OrdercheckListPostModal.fromJson(Map<String, dynamic> jsons,int stcode) {
      return OrdercheckListPostModal(
        stcode: stcode,
        exception:null,
        DocNum:jsons["DocNum"],
        error: null
  ...
  factory OrdercheckListPostModal.error(String jsons,int stcode) {
    return OrdercheckListPostModal(
        stcode: stcode,
        exception:jsons,
        DocNum:null,
   ...
   factory OrdercheckListPostModal.issue(Map<String, dynamic> jsons, int stcode) {
    return OrdercheckListPostModal(
        stcode: stcode,
        exception:null,
        DocNum:null,
