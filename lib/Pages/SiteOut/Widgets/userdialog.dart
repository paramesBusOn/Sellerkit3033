...
class ShowSearchDialogState extends State<EnqAssignUserDialog> {
              ...
              child: Column(
                ...
                children: [
                  Container(
                            ...
                            child: TextField(
                              // controller:context.read<SiteOutController>().mycontroller[5] ,
                              onTap: () {
                              ...
                              onChanged: (v) {
                                setState(() {
                                                                  context.read<SiteOutController>().filterListAssignData(v);
                                });
                              },
  ...
  List<Widget> listContainersProduct(
    ...
    return List.generate(
     context.watch<SiteOutController>().filteruserLtData.length,
      (ind) => GestureDetector(
        onTap: () {
