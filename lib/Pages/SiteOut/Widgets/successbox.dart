...
class _FollowUPDialogPGState extends State<SuccessDialogPG> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<SiteOutController>(
        create: (context) => SiteOutController(),
        builder: (context, child) {
          return Consumer<SiteOutController>(
  ...
  Container CallDialog(
      BuildContext context, ThemeData theme, SiteOutController fUPCon) {
    return Container(
  ...
  // Widget createTable(ThemeData theme, SiteOutController fUPCon) {
  //   List<TableRow> rows = [];
