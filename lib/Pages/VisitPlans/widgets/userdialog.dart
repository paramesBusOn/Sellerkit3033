...
class ShowSearchDialogState extends State<EnqAssignUserDialog> {
    ...
    return Container(
      ...
      child: Column(
              ...
              child: Column(
                ...
                children: [
                  Container(
                            ...
                            child: TextField(
                              // controller:context.read<NewVisitplanController>().mycontroller[5] ,
                              onTap: () {
                              ...
                              onChanged: (v) {
                                setState(() {
                                                                  context.read<NewVisitplanController>().filterListAssignData(v);
                                });
                              },
        ...
        Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                 context.read<NewVisitplanController>().selectedAssignedUser();
  ...
  List<Widget> listContainersProduct(
    ...
    return List.generate(
     context.watch<NewVisitplanController>().filteruserLtData.length,
      (ind) => GestureDetector(
        onTap: () {
          context.read<NewVisitplanController>().selectedIdxFUser = ind;
          context.read<NewVisitplanController>().selectUser(ind);
        },
        child: Container(
