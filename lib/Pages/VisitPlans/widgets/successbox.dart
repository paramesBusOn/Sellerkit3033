...
class _FollowUPDialogPGState extends State<SuccessDialogPG> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<NewVisitplanController>(
        create: (context) => NewVisitplanController(),
        builder: (context, child) {
          return Consumer<NewVisitplanController>(
  ...
  Container CallDialog(
      BuildContext context, ThemeData theme, NewVisitplanController fUPCon) {
    return Container(
  ...
  // Widget createTable(ThemeData theme, NewVisitplanController fUPCon) {
  //   List<TableRow> rows = [];
