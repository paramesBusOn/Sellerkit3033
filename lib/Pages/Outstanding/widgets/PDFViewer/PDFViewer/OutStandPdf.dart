...
class OutStandingPdf extends StatefulWidget {
  const OutStandingPdf({Key? key}) : super(key: key);

  @override
  State<OutStandingPdf> createState() => OutStandingPdfState();
}

class OutStandingPdfState extends State<OutStandingPdf> {
    ...
    return Scaffold(
      ...
      body: PdfPreview(
          ...
          build: (format)
              ...
              {
            // OutStandingPdfHelper.data2 = data2;
            // OutStandingPdfHelper.paymode = paymode;
            // log("paymode::" + paymode.toString());

            // OutStandingPdfHelper.orderMasterdata = orderMasterdata;

            // OutStandingPdfHelper.customermodeldata = customermodeldata;
            return OutStandingPdfHelper.generatePdf(format, 'title');
          }),
    );
  }
