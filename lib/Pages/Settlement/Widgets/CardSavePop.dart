...
class CardAlertBoxState extends State<CardAlertBox> {
  @override
  void initState() {
    setState(() {
      context.read<SettlementController>().settleTocard = null;
    });
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Form(
                key: context.read<SettlementController>().formkey[1],
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        value:
                            context.read<SettlementController>().settleTocard,
                        onChanged: (val) {
                          setState(() {
                            context
                                .read<SettlementController>()
                                .chooseSettleToCard(val.toString());
                          });
                        },
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  context
                      .read<SettlementController>()
                      .validateFinalCard(context);
                  context.read<SettlementController>().totalCardsettl();
                  SettlementPdfHelper.settledRef =
                      context.read<SettlementController>().mycontroller[2].text;
