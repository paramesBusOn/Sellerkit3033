...
class DDAlertBox extends StatefulWidget {
  DDAlertBox({Key? key, required this.indx}) : super(key: key);
  final int indx;
  @override
  State<DDAlertBox> createState() => DDAlertBoxState();
}

class DDAlertBoxState extends State<DDAlertBox> {
  @override
  void initState() {
    context.read<SettlementController>().settleToDD = null;
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Form(
                key: context.read<SettlementController>().formkey[4],
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text(
                        "Total Amount Rs.${context.read<SettlementController>().totalDD()}",
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField(
                          ...
                          isExpanded: true,
                          value:
                              context.read<SettlementController>().settleToDD,
                          onChanged: (val) {
                            setState(() {
                              context
                                  .read<SettlementController>()
                                  .chooseSettleToDD(val.toString());
                            });
                          },
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  context.read<SettlementController>().validateFinalDD(context);
                  context.read<SettlementController>().totalDDsettl();
