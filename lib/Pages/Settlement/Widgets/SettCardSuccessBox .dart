...
class SettlementSuccessCard extends StatefulWidget {
  SettlementSuccessCard({Key? key, required this.settlemaster})
      : super(key: key);
  // final String? paymode;
  // final double? amount;
  List<SettlementPostData>? settlemaster;
  @override
  State<SettlementSuccessCard> createState() => SettlementSuccessCardState();
}

class SettlementSuccessCardState extends State<SettlementSuccessCard> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Center(
                              child: Text(
                            "Settlement Receipt #${widget.settlemaster![0].DocNum}",
                            style: theme.textTheme.bodyText2,
                            textAlign: TextAlign.center,
                          )),
                        ),
                          ...
                          child: GestureDetector(
                            onTap: () {
                              SettlementPdfHelper.setDocfNum =
                                 widget.settlemaster![0].DocNum.toString();
