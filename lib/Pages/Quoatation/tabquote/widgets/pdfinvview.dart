...
//   static dynamic width;
  static List<GetQuotesQTLData> data2 = [];
  static customerdetData? customermodeldata;
  static List<GetQuotesDeatilsQTHData>? orderMasterdata2 = [];
  static List<GetQuotesDeatilsQTHData>? orderMasterdata = [];
...
// }
  ...
  static pw.Widget buildHeader(List<GetQuotesDeatilsQTHData>? orderMasterdata, TtfFont font,
...
//                       Column(children: [
  ...
  static Widget buildTotal(List<GetQuotesDeatilsQTHData>? orderMasterdata, TtfFont font,
      TtfFont Calibrifont, Config config, TtfFont Calibrifontbold) {
    //
