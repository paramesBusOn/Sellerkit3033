...
class pdfviewState extends State<pdfview> {
  ...
  static List<GetQuotesQTLData> data = [];
  static String paymode = '';
  List<GetQuotesQTLData> data2 = [];
  static customerdetData? customermodeldata;
  // List<DocumentLines> data4 = [];
  List<GetQuotesQTLData> data5 = [];
  List<GetQuotesQTLData> data6 = [];
  static List<GetQuotesDeatilsQTHData>? orderMasterdata2 = [];
  List<GetQuotesDeatilsQTHData>? orderMasterdata = [];
