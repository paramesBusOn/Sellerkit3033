...
import 'package:sellerkit/Pages/Quoatation/tabquote/widgets/pdfinvoice.dart';
import 'package:sellerkit/Services/customerdetApi/customerdetApi.dart';

class pdfqoutes extends StatefulWidget {
  const pdfqoutes({Key? key}) : super(key: key);

  @override
  State<pdfqoutes> createState() => pdfqoutesState();
}

class pdfqoutesState extends State<pdfqoutes> {
    ...
    return Scaffold(
      ...
      body: PdfPreview(
        ...
        // _generatePdf(format, 'title'),
         {
          PdfInvoicePdfHelperQuotes.data2=data2;
          PdfInvoicePdfHelperQuotes.paymode=paymode;
          PdfInvoicePdfHelperQuotes. customermodeldata = customermodeldata;
          // PdfInvoicePdfHelper.height=MediaQuery.of(context).size.height;
          // PdfInvoicePdfHelper.width=MediaQuery.of(context).size.width;
         PdfInvoicePdfHelperQuotes. orderMasterdata=orderMasterdata;
          return PdfInvoicePdfHelperQuotes.generatePdf(format, 'title');
        } 
