...
class AssignedToDialogManager extends StatefulWidget {
  AssignedToDialogManager({Key? key, required this.indx}) : super(key: key);
  final int indx;
  @override
  State<AssignedToDialogManager> createState() => AssignedToDialogUserState();
}

class AssignedToDialogUserState extends State<AssignedToDialogManager> {
  @override
                  ...
                  if (context.read<EnquiryMangerContoller>().getUserKey == null) {
                    ...
                    context.read<EnquiryMangerContoller>().callAsignedToApi(
                        ...
                        context
                            ...
                            .getassignedEnqData[widget.indx] 
                          ,
                        context
                            .read<EnquiryMangerContoller>()
        ...
        children: [
                            ...
                            // context.read<EnquiryMangerContoller>().mycontroller[0].text.isNotEmpty
                               ...
                               context
                                    ...
                                    .callAsignedToApi(
                                      context
                                  .read<EnquiryMangerContoller>()
                                  .getassignedEnqData[widget.indx],ConstantValues.UserId,context
                                    .read<EnquiryMangerContoller>()
                                    .temp2!.CODE.toString(),context
                                    );
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.pop(context);
                context.read<EnquiryMangerContoller>().mapValuesToLead(widget.indx);
              },
              style: ElevatedButton.styleFrom(
                textStyle: TextStyle(
                    // fontSize: 12,
            ...
            Container(
              ...
              child: ElevatedButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Call assigned to ${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].AssignedTo_UserName}",
                      ),
                      Text(
                        "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].Status}",
                      ),
                    ],
                  )),
            ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        //    width: Screens.width(context) * 0.4,
                        child: Text(
                            "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].CardName}",
                      ...
                      Container(
                        ...
                        child: Text(
                            context.read<EnquiryMangerContoller>().config.alignDate(
                                "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].EnqDate}"),
                            style: theme.textTheme.bodyText2?.copyWith(
                              color: theme.primaryColor,
                              //fontWeight: FontWeight.bold
                            )),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        width: Screens.width(context) * 0.4,
                        child: Text(
                            "Looking for ${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].Lookingfor}",
                            style: theme.textTheme.bodyText2?.copyWith(
                              color: theme.primaryColor,
                              //  fontWeight: FontWeight.bold
                            )),
                      ...
                      Container(
                        ...
                        child: Text(
                            "₹ ${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].PotentialValue}",
                            style: theme.textTheme.bodyText2?.copyWith(
                              color: theme.primaryColor,
                              // fontWeight: FontWeight.bold
                            )),
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                            context.read<EnquiryMangerContoller>().config.alignDate(
                                "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].Followup}"),
                            style: theme.textTheme.bodyText2?.copyWith(
                              color: theme.primaryColor,
                              //fontWeight: FontWeight.bold
                            )),
                      ...
                      Container(
                        ...
                        width: Screens.width(context) * 0.45,
                        child: Text(
                            "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].EnqType}",
                            textAlign: TextAlign.right,
                            style: theme.textTheme.bodyText2?.copyWith(
                              color: theme.primaryColor,
                              //  fontWeight: FontWeight.bold
                  ...
                  Column(children: [
                    ...
                    Container(
                      ...
                      //color: Colors.red,
                      child: Text(
                          "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].Address_Line_1}",
                          style: theme.textTheme.bodyText2?.copyWith(
                            color: theme.primaryColor,
                            //  fontWeight: FontWeight.bold
                          )),
                    ...
                    Container(
                      ...
                      //color: Colors.red,
                      child: Text(
                          "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].Address_Line_2}",
                          style: theme.textTheme.bodyText2?.copyWith(
                            color: theme.primaryColor,
                            // fontWeight: FontWeight.bold
                          )),
                    ...
                    Container(
                      ...
                      //color: Colors.red,
                      child: Text(
                          "${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].City} - ${context.watch<EnquiryMangerContoller>().getassignedEnqData[widget.indx].Pincode}",
                          style: theme.textTheme.bodyText2?.copyWith(
                            color: theme.primaryColor,
                            //fontWeight: FontWeight.bold
                          )),
