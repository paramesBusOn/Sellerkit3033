    ...
    return WillPopScope(
      ...
      child: Scaffold(
                    ...
                    child: Column(
                      children: [
                        Container(
                            ...
                            child: TextField(
                              controller:context.read<EnquiryUserContoller>().mycontroller[5] ,
                              onTap: () {
                              ...
                              onChanged: (v) {
                                ...
                                context.read<EnquiryUserContoller>().SearchFilterOpenTab(v);

                              }else if(controller!.index.toString()=="1"){
                                                                  context.read<EnquiryUserContoller>().SearchFilterWonTab(v);

                                }else{
                                context.read<EnquiryUserContoller>().SearchFilterLostTab(v);
        ...
        body: GestureDetector(onHorizontalDragUpdate: (details) {
          ...
          context.watch<EnquiryUserContoller>().getdatagotByApi == true &&
              ...
              : context.watch<EnquiryUserContoller>().getdatagotByApi == true &&
                      ...
                      context.watch<EnquiryUserContoller>().getErrorMsg.isNotEmpty
                  ? Center(
                      child:
                          Column(
                             mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                                   context.watch<EnquiryUserContoller>().lottie!.isEmpty?Container():
                                context.watch<EnquiryUserContoller>().lottie!.isNotEmpty && context.watch<EnquiryUserContoller>().lottie!.contains(".png")?     InkWell(
                    onTap: () {
                      // HelperFunctions.clearCheckedOnBoardSharedPref();
                      // HelperFunctions.clearUserLoggedInSharedPref();
                    },
                    child: Image.asset('${context.watch<EnquiryUserContoller>().lottie}',
        ...
        // color:Colors.transparent,
                    ...
                    child: Lottie.asset('${context.watch<EnquiryUserContoller>().lottie}',
                        animate: true,
                        repeat: true,
                        // height: Screens.padingHeight(context) * 0.3,
                        width: Screens.width(context) * 0.4),
                  ),
                              Text(context.watch<EnquiryUserContoller>().getErrorMsg,textAlign: TextAlign.center,),
                            ],
                          ))
                  : 
                  // context.watch<EnquiryUserContoller>().getdatagotByApi == true &&
