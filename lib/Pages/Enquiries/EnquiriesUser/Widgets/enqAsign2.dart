...
class EnqAssignUserDialog2 extends StatefulWidget {
  EnqAssignUserDialog2({Key? key}) : super(key: key);
  @override
  State<EnqAssignUserDialog2> createState() => ShowSearchDialogState();
}

class ShowSearchDialogState extends State<EnqAssignUserDialog2> {
  @override
    ...
    return Container(
      ...
      child: Column(
                ...
                children: [
                  Container(
                            ...
                            child: TextField(
                              ...
                              onChanged: (v) {
                                setState(() {
                                                                  context.read<NewEnqController>().filterListAssignData2(v);
                                });
                              },
        ...
        Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                 context.read<NewEnqController>().selectedAssignedUser2();
  ...
  List<Widget> listContainersProduct(
    ...
    return List.generate(
     context.watch<NewEnqController>().filteruserLtData2.length,
      (ind) => GestureDetector(
        onTap: () {
          context.read<NewEnqController>().selectedIdxFUser2 = ind;
          context.read<NewEnqController>().selectUser2(ind);
        },
        child: Container(
