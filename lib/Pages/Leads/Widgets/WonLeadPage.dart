...
class WonLeadPage extends StatelessWidget {
  const WonLeadPage(
      {Key? key,
      required this.theme,
  ...
  final List<GetAllLeadData> leadWonAllData;

  final List<SummaryLeadData> leadSummaryWon;
    ...
    return Container(
      ...
      child: Column(
        ...
        // color:Colors.transparent,
              ...
              ListView.builder(
                itemCount: leadWonAllData.length,
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Container(
                                      width: Screens.width(context) * 0.4,
                                      child: Text(
                                          leadWonAllData[i].NextFollowup!.isEmpty
                                              ? ''
                                              : context
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        width: Screens.width(context) * 0.4,
                                        child: Text(
                                            leadWonAllData[i].Value == -1
                                                ? ""
                                                : context
                                                    .read<LeadTabController>()
                                                    .config
                                                    .slpitCurrency(leadWonAllData[
                                                            i]
                                                        .Value!
                                                        .toStringAsFixed(
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                        leadWonAllData[i].createdDate!.isEmpty
                                            ? ''
                                            : "Created Date: " +
                                                context
