...
class KPIScreen extends StatefulWidget {
  KPIScreen({
    Key? key,
    required this.color, required List<KpiModelData2> kpiData,
  }) : super(key: key);
                          ...
                          children: [
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![0].mainValue}',
                            ),
                            TokenWidgets(
                              theme: theme,
                              color: context
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![1].mainValue}',
                            ),
                            TokenWidgets(
                              theme: theme,
                              color: context
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![2].mainValue}',
                            ), //.toStringAsFixed(2)
                          ],
                        ),
                        SizedBox(
                          ...
                          children: [
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![3].mainValue}',
                            ),
                            TokenWidgets(
                              theme: theme,
                              color: context
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![4].mainValue}',
                            ),
                            TokenWidgets(
                              theme: theme,
                              color: context
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![5].mainValue}',
                            ), //.toStringAsFixed(2)
                          ],
                        ),
                        SizedBox(
                          ...
                          children: [
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![6].mainValue}',
                            ...
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![7].mainValue}',
                            ...
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![8].mainValue}'
                          ...
                          children: [
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![9].mainValue}',
                            ...
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![10].mainValue}',
                            ), //.toStringAsFixed(2)
                            TokenWidgets(
                              theme: theme,
                              color: context
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![11].mainValue}',
                            ),
                          ],
                        ),
                        SizedBox(
                          ...
                          children: [
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![12].mainValue}',
                            ), //.toStringAsFixed(2)
                            ...
                            TokenWidgets(
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![13].mainValue}',
                            ),
                            TokenWidgets(
                              theme: theme,
                              color: context
                              ...
                              name: context
                                  ...
                                  .toString(),
                              value:
                                  '${context.watch<DashBoardController>().getNewKpiData2![14].mainValue}',
                            ),
                          ],
                        ):Container()
                      ],
