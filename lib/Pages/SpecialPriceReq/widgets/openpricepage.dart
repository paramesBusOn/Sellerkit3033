...
class openpriccepage extends StatefulWidget {
   openpriccepage({Key? key,
   required this.theme,
...
tabpriceController provi;
  @override
  State<openpriccepage> createState() => _openpriccepageState();
}

class _openpriccepageState extends State<openpriccepage> {
  @override
