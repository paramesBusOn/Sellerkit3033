// ignore_for_file: unused_import, implementation_imports, unnecessary_string_interpolations, prefer_const_constructors, unused_field, prefer_final_fields
...
class DayStartEndPage extends StatefulWidget {
  const DayStartEndPage({Key? key});

  @override
  State<DayStartEndPage> createState() => DayStartEndPageState();
}

class DayStartEndPageState extends State<DayStartEndPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(        drawerEnableOpenDragGesture: false,
        ...
        appBar: appbar("Day Start", scaffoldKey,theme, context),
