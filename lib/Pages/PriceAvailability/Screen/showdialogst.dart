       ...
       child: Column(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child: Text("${context.read<PriceListController>().itemviewdata[0].itemcode}",style:  theme.textTheme.bodyText2?.copyWith(color: theme.primaryColor)),
            ),
             SizedBox(
                          height: Screens.bodyheight(context) * 0.01,
                        ),
