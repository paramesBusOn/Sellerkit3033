  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:
        ...
        child: context.watch<AccountsContoller>().outloading == true
            ? Center(
                                                        ...
                                                        context
                                                            ...
                                                            .calldialApi(
                                                                context
                                                                    ...
                                                                    .CustomerCode
                                                                    .toString(),
                                                                context); // context.read<EnquiryUserContoller>(). showSpecificDialog();
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child: Text(
                                                                              context.watch<AccountsContoller>().getdetaildataEnq![i].CurrentStatus!.isEmpty ? '' : "${context.watch<AccountsContoller>().getdetaildataEnq![i].CurrentStatus}",
                                                                              style: theme.textTheme.bodyText2?.copyWith(
                                                                                //color:theme.primaryColor,
                                                                      ...
                                                                      children: [
                                                                        Container(
                                                                          width:
                                                                              Screens.width(context) * 0.4,
                                                                          child: Text(
                                                                              context.watch<AccountsContoller>().getdetaildataEnq![i].DocDate!.isEmpty ? '' : context.read<AccountsContoller>().config.alignDate("${context.watch<AccountsContoller>().getdetaildataEnq![i].DocDate}"), //  "Looking for ${context.watch<EnquiryUserContoller>().getopenEnqData[i].Lookingfor}",
                                                                              style: theme.textTheme.bodyText2?.copyWith(
                                                                                  //color:theme.primaryColor,
                                                                                  //fontWeight: FontWeight.bold
                                                                                  )),
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            width:
                                                                                Screens.width(context) * 0.4,
                                                                            child: Text(context.watch<AccountsContoller>().getdetaildataEnq![i].BusinessValue == -1 ? "" : context.read<AccountsContoller>().config.slpitCurrency(context.watch<AccountsContoller>().getdetaildataEnq![i].BusinessValue!.toStringAsFixed(0)), //  "₹ ${context.watch<EnquiryUserContoller>().getopenEnqData[i].PotentialValue}",
                                                                                style: theme.textTheme.bodyText2?.copyWith(
                                                                                    //color:theme.primaryColor,
                                                                                    //fontWeight: FontWeight.bold
                                                                                    )),
