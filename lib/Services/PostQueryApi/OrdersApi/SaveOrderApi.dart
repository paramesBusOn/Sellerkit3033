...
class OrderSavePostApi {
    ...
    try {
     log("postLead.paymentdata::"+postLead.paymentdata!.length.toString()); 
      ...
      final response = await http.post(
          Uri.parse(Url.queryApi + 'Sellerkit_Flexi/v2/OrderAdd'),
          headers: {
  ...
  "alternatemobile": patch.altermobileNo==null||patch.altermobileNo!.isEmpty?null: "${patch.altermobileNo}",
  "contactname":patch.cantactName==null||patch.cantactName!.isEmpty?null: "${patch.cantactName!.replaceAll("'", "")}",
  "customeremail":patch.U_EMail==null||patch.U_EMail!.isEmpty?null:  "${patch.U_EMail!.replaceAll("'", "")}",
  "companyname": null,
  "pan": null,
  ...
  "basetype": patch.enqtype,
   "attachurl1":postLead.attachmenturl1==null||postLead.attachmenturl1!.isEmpty?null: "${postLead.attachmenturl1}",
  "attachurl2": postLead.attachmenturl2==null||postLead.attachmenturl2!.isEmpty?null:"${postLead.attachmenturl2}",
  "attachurl3":postLead.attachmenturl3==null|| postLead.attachmenturl3!.isEmpty?null:"${postLead.attachmenturl3}",
  "attachurl4":postLead.attachmenturl4==null|| postLead.attachmenturl4!.isEmpty?null:"${postLead.attachmenturl4}",
  "attachurl5":postLead.attachmenturl5==null||postLead.attachmenturl5!.isEmpty?null: "${postLead.attachmenturl5}",
  ...
  log("json.decode(response.body)::"+json.decode(response.body).toString());
      ...
      print("Exceptionorder: " + e.toString());
      // return resCode;
