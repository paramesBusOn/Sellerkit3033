...
class OrderFollowupApi {
  static Future<int> getData(
      sapUserId, OrderFollowupApiData leadFollowupApiData, int docEntry) async {
    int resCode = 500;
...
class OrderFollowupApiData {
  String? name;
  String? code;
  String? date;
  String? nextFollowUp;
  OrderFollowupApiData({this.code,this.name,this.date, this.nextFollowUp});
}
