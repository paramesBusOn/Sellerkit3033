...
//// view all
  ...
  isselectedbrandViewAllPage() async {
    ...
    isselectedViewAllString.clear();
     viewAll.clear();
     searchviewAll.clear();
    log("log view1: "+viewAll.length.toString());
   // isselectedViewAllString.clear();
    if(isBPSSelected == false){
       viewAll = await DBOperation.getViewAllData("Brand",db);
       searchviewAll=viewAll;
       notifyListeners();
    Get.toNamed(ConstantRoutes.priceListViewAll)!.then(
      (value) {
  ...
  // else if(isBrandViewAllSelected == true){
      viewAll = brandList;
       searchviewAll=viewAll;
       notifyListeners();
        Get.toNamed(ConstantRoutes.priceListViewAll)!.then(
    ...
    log("log view2: "+viewAll.length.toString());
  ...
  addBrandViewAll(String brand) {
    ...
    print("length: "+viewAll.length.toString());
    notifyListeners();
  }
  ...
  isselectedProductViewAllPage() async {
   ...
   searchviewAll.clear();
   isselectedViewAllString.clear();
    // viewAll = await dbHelper.getViewAllData("Category");
    // Get.toNamed(ConstantRoutes.priceListViewAll)!.then(
    //   (value) {
    //     notifyListeners();
    //   },
    // );
    print("isBPSSelected: "+isBPSSelected.toString());
    print("isProductViewAllSelected: "+isProductViewAllSelected.toString());
  ...
  //  else if(isProductViewAllSelected == true){
    else if(isBPSSelected == true){
     viewAll = productList;
     searchviewAll=viewAll;
       notifyListeners();
  ...
  isselectedProductViewAll(int i) {
    if (searchviewAll[i].isselected == 0) {
      searchviewAll[i].isselected = 1;
      addProductViewAll(searchviewAll[i].category);
    //  isSelectedBPS();
    } else {
      searchviewAll[i].isselected = 0;
      removeProductViewAll(searchviewAll[i].category);
    }
  }

  addProductViewAll(String category) {
    isselectedViewAllString.add("'$category'");
    print("Product: " + isselectedViewAllString.toString());
    notifyListeners();
  }

  removeProductViewAll(String category) {
    isselectedViewAllString.remove("'$category'");
    print("Productremoved: " + isselectedViewAllString.toString());
    notifyListeners();
  }
...
//segment view all
  ...
  isselectedSegmentViewAllPage() async {
   ...
   searchviewAll.clear();
   isselectedViewAllString.clear();
    // viewAll = await dbHelper.getViewAllData("Segment");
    // Get.toNamed(ConstantRoutes.priceListViewAll)!.then(
    //   (value) {
    //     notifyListeners();
    //   },
   ...
   // else if(isSegmentViewAllSelected == true){
     viewAll = segmentList ;
     searchviewAll=viewAll;
       notifyListeners();
      Get.toNamed(ConstantRoutes.priceListViewAll)!.then(
  ...
  isselectedSegmentViewAll(int i) {
    if (searchviewAll[i].isselected == 0) {
      searchviewAll[i].isselected = 1;
      addSegmentViewAll(searchviewAll[i].category);
     // isSelectedBPS();
    } else {
      searchviewAll[i].isselected = 0;
      removeSegmentViewAll(searchviewAll[i].category);
    }
    notifyListeners();
  }
  ...
  Future<List<ItemMasterDBModel>> brandViewAllData() async {
    ...
    if (isselectedViewAllString.isNotEmpty) {
      // brandList.clear();
      // isselectedBrandString.clear();
       log("log view33: "+viewAll.length.toString());
    log("data view111: "+ viewAll.length.toString());

      for (int i = 0; i < viewAll.length; i++) {
    print("data view: "+ viewAll.length.toString());
  ...
  Future<List<ItemMasterDBModel>> productViewAllData() async {
    ...
    if (isselectedViewAllString.isNotEmpty) {
      ...
      for (int i = 0; i < viewAll.length; i++) {
        ...
        storeAgeSlab1:viewAll[i].storeAgeSlab1,
          storeAgeSlab2:viewAll[i].storeAgeSlab2,
          storeAgeSlab3:viewAll[i].storeAgeSlab3,
          storeAgeSlab4:viewAll[i].storeAgeSlab4,
          storeAgeSlab5:viewAll[i].storeAgeSlab5,
          whsAgeSlab1:viewAll[i].whsAgeSlab1,
          whsAgeSlab2:viewAll[i].whsAgeSlab2,
          whsAgeSlab3:viewAll[i].whsAgeSlab3,
          whsAgeSlab4:viewAll[i].whsAgeSlab4,
          whsAgeSlab5:viewAll[i].whsAgeSlab5,
...
//filter
  ...
  // callItemMasterPriceUpdate( String itemcode, int tmid, int indexfromList) async {
